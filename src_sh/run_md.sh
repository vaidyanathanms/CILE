...
if ! test -f "$fmin_inp"; then
	...
	# run enermin.tpr
	srun gmx mdrun -s min_noflex.tpr -cpo state_min2.cpt -cpi state_min2.cpt -cpt 2 -g md_min2.log -o traj_min2.trr -e ener_min2.edr -c confout_min2.gro -notunepme 
	wait
